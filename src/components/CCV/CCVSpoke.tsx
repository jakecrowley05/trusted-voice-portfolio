...
const FeatureCard = ({ icon, title, description }) => (
  <div className="group bg-white p-8 rounded-2xl border border-slate-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
    <div className="w-14 h-14 rounded-xl bg-slate-100 flex items-center justify-center mb-6 group-hover:bg-slate-200 transition-colors">
      {icon}
    </div>
...
const CCVSpoke = () => {
  ...
  return (
    <section id="spoke" className="py-32 px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
            I've partnered with a private team of senior engineers to deliver custom development solutions for ambitious founders
          </p>
        </div>
          ...
          <div className="bg-slate-50 rounded-3xl p-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                ...
                className="bg-black text-white hover:bg-slate-800 px-8 py-4 text-lg rounded-xl"
              >
                Request a Quote
              ...
              <Button 
                variant="outline"
                onClick={handleRequestQuote}
                className="border-slate-300 text-slate-700 hover:bg-slate-50 px-8 py-4 text-lg rounded-xl"
              >
                See Past Projects
              </Button>
            </div>
