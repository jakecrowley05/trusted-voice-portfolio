      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="#process" className="text-gray-700 hover:text-primary font-medium transition-colors">How It Works</a>
            ...
            <Link to="/dashboard" className="text-gray-700 hover:text-primary font-medium transition-colors">Dashboard</Link>
            <Button asChild className="rounded-md px-6 bg-primary hover:bg-primary/90">
          ...
          <div className="md:hidden pt-4 pb-3 animate-fade-in bg-white">
            <div className="flex flex-col space-y-4">
              ...
              <div className="px-4 pt-2">
                <Button asChild className="w-full rounded-md bg-primary hover:bg-primary/90">
