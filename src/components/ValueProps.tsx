    ...
    <section id="why-jake" className="py-20">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        <ValuePropItem 
          ...
          description="Led PMF pivots across 3 early-stage ventures, turning struggling products into market winners."
        />
        <ValuePropItem 
          icon={<Zap className="h-6 w-6 text-lime-500" />}
          title="AI Product Builder"
          description="Built NobleLoop — a real-time AI engagement platform that connects with customers at scale."
        />
        <ValuePropItem 
          icon={<Search className="h-6 w-6 text-lime-500" />}
          title="User Insight Leader"
          description="Run 20+ user insight sprints with real traction gains, revealing why users actually stay or leave."
        />
      </div>
      
      <div className="mt-16 p-8 bg-slate-100 rounded-xl">
        <blockquote className="italic text-xl text-center text-slate-700">
          "Jake helped us realize we were solving the wrong problem. Within weeks, our engagement metrics completely transformed."
        </blockquote>
