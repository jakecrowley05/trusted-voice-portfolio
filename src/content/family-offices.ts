// Family Offices and Private Capital page.

export const familyOffices = {
  heading: "Family Offices and Private Capital",
  intro:
    "Family offices think in generations, not fund cycles. We work alongside them as a principal.",
  worksWith: [
  ...
  paragraphs: [
    ...
    "We also maintain manager relationships and support long-term portfolio construction where a family's objectives call for it.",
    "The through-line is a private-markets ecosystem where capital, relationships and opportunity meet, built on the premise that the best allocations begin with trust and hold because the incentives are aligned.",
  ],
  themes: [
    "Co-investments", "Direct investments", "Private equity", "Venture capital", "Secondaries",
    "Alternative assets", "Strategic projects", "Global opportunities", "Manager relationships",
    "Long-term portfolio construction", "Infrastructure", "Defense and dual-use", "Space",
    "Sports assets", "Real assets",
  ],
